...
const Sales = () => {
  return (
    <div className='flex flex-row items-center justify-center pt-0 p-2'>
      <Image className='pt-9' src={'/Van.png'} alt='van with a colleague' width={500} height={800}/>
      <div>
...
<p className='py-0.5'>Is your home experiencing a broken boiler, leaving you in the cold, or are persistent plumbing issues like dripping faucets, slow drains, and sudden leaks creating daily frustrations and potential damage?</p>
 <p className='py-0.5'>Heatwave is here to restore your peace of mind and the smooth operation of your home. We proudly provide highly reliable heating solutions and expert plumbing services directly to your Leicestershire home, ensuring you a consistently comfortable and perfectly functional living space year-round, free from worries about your essential systems. As your trusted local team, deeply invested in the community, we offer genuinely prompt, remarkably efficient, and always friendly service, including a crucial 24/7 emergency response for those unexpected critical moments. </p>
 <p className='py-0.5'>With our commitment to clarity, we provide <span className='font-bold'>free estimates</span> and <span className='font-bold'>transparent pricing</span>  from the outset, so you can experience the Heatwave difference – where quality workmanship and unparalleled customer care are always guaranteed. 
 </p>
